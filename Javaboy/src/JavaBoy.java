...
//#########################################################################################################################
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().contains("Size")) {
			action.executeAction(e.getActionCommand(), new SizeAction());
			dmgcpu.graphicsChip.setMagnify(action.getSize());
			imageSizeChanged = true;	
		} else if (e.getActionCommand().contains("FrameSkip")) {
			action.executeAction(e.getActionCommand(), new SizeAction());
			dmgcpu.graphicsChip.frameSkip = action.getFrame();
...
//########################################################################################################################
	/** Método refatorado com os padrões State */
	public void keyPressed(KeyEvent e) {
		
		KeyState keyState = new KeyState();

		if (e.getKeyCode() == keyCodes[0]) {
			dmgcpu.ioHandler.padUp = keyState.IsChange(e.getKeyCode() == keyCodes[0]);
		} else if (e.getKeyCode() == keyCodes[1]) {
			dmgcpu.ioHandler.padDown = keyState.IsChange(e.getKeyCode() == keyCodes[1]);
		} else if (e.getKeyCode() == keyCodes[2]) {
			dmgcpu.ioHandler.padLeft = keyState.IsChange(e.getKeyCode() == keyCodes[2]);
		} else if (e.getKeyCode() == keyCodes[3]) {
			dmgcpu.ioHandler.padRight = keyState.IsChange(e.getKeyCode() == keyCodes[3]);
		} else if (e.getKeyCode() == keyCodes[4]) {
			dmgcpu.ioHandler.padA = keyState.IsChange(e.getKeyCode() == keyCodes[4]);
		} else if (e.getKeyCode() == keyCodes[5]) {
			dmgcpu.ioHandler.padB = keyState.IsChange(e.getKeyCode() == keyCodes[5]);
		} else if (e.getKeyCode() == keyCodes[6]) {
			dmgcpu.ioHandler.padStart = keyState.IsChange(e.getKeyCode() == keyCodes[6]);
		} else if (e.getKeyCode() == keyCodes[7]) {
			dmgcpu.ioHandler.padSelect = keyState.IsChange(e.getKeyCode() == keyCodes[7]);
		}
...
//############################################################################################################################
	/** Método refatorado com os padrões Strategy */
	public void keyReleased(KeyEvent e) {

		KeyStrategy keyStrategy = new KeyStrategy();

		if (e.getKeyCode() == keyCodes[0]) {
			dmgcpu.ioHandler.padUp = keyStrategy.IsTrue(e.getKeyCode() == keyCodes[0]);
		} else if (e.getKeyCode() == keyCodes[1]) {
			dmgcpu.ioHandler.padDown = keyStrategy.IsTrue(e.getKeyCode() == keyCodes[1]);
		} else if (e.getKeyCode() == keyCodes[2]) {
			dmgcpu.ioHandler.padLeft = keyStrategy.IsTrue(e.getKeyCode() == keyCodes[2]);
		} else if (e.getKeyCode() == keyCodes[3]) {
			dmgcpu.ioHandler.padRight = keyStrategy.IsTrue(e.getKeyCode() == keyCodes[3]);
		} else if (e.getKeyCode() == keyCodes[4]) {
			dmgcpu.ioHandler.padA = keyStrategy.IsTrue(e.getKeyCode() == keyCodes[4]);
		} else if (e.getKeyCode() == keyCodes[5]) {
			dmgcpu.ioHandler.padB = keyStrategy.IsTrue(e.getKeyCode() == keyCodes[5]);
		} else if (e.getKeyCode() == keyCodes[6]) {
			dmgcpu.ioHandler.padStart = keyStrategy.IsTrue(e.getKeyCode() == keyCodes[6]);
		} else if (e.getKeyCode() == keyCodes[7]) {
			dmgcpu.ioHandler.padSelect = keyStrategy.IsTrue(e.getKeyCode() == keyCodes[7]);
		}
